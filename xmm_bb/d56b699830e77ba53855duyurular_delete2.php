...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM duyurular WHERE duyuru_id=%s",
  ...
  $deleteGoTo = "d56b699830e77ba53855duyurular_delete.php";
...
<p class="parag">&nbsp;<a href="d56b699830e77ba53855679cb1d252da01.php" class="paraglink"><img src="images/Home.png" width="24" height="24" border="0" />Anasayfa</a></p>
             ...
             <p class="parag">.</p>
<p class="parag"><b><a href="d56b699830e77ba53855duyurular.php" class="paraglink"> Duyurular</a></b></p></td>
          </tr>
        </table>
          <br /></td>
      </tr>
