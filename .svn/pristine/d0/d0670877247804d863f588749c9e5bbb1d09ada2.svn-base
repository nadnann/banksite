...
<link href="css/style_include.css" rel="stylesheet" type="text/css" />
</head>
  ...
  <tr>
    <td width="968" colspan="3"><table width="969" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
      ...
      <tr>
        ...
        <table width="918" height="123" border="0" cellpadding="4" cellspacing="7" id="Table_" vspace="0" align="CENTER">
      <tr>
        <td width="896" height="109" align="left" valign="top"><header class="template_baslik">HUMAN RESOURCE</header>
<table width="903" border="0" cellpadding="0" cellspacing="0" class="table_border">
  <tr>
    <td width="900">
    <table width="500" align="CENTER" class="table_isbasvurusu" cellspacing="2">
    <tr>
            
              <td colspan="2" align="CENTER" valign="MIDDLE"><label for="textfield5">İş Başvuru Formu</label></td>
    </tr>
            <tr>
    ...
    <tr><td bgcolor="#F3F3F3">&Ouml;ğrenim Durumu:</td><td bgcolor="#F3F3F3"><LABEL for="ikform_soyad"><select name="ikform_ogrenim" id="ikform_ogrenim"><option selected="selected">Se&ccedil;iniz</option><option value="Lisans&uuml;st&uuml;/Doktora">Lisans&uuml;st&uuml;/Doktora</option><option value="Lisans">Lisans</option><option value="&Ouml;n Lisans">&Ouml;n Lisans</option><option value="Lise">Lise</option><option value="İlkokul/Ortaokul">İlkokul/Ortaokul</option></select></LABEL></td></tr>
            <tr><td bgcolor="#F3F3F3">Başvurduğunuz Pozisyon:</td><td bgcolor="#F3F3F3"><LABEL for="select2"></LABEL><select name="select2" id="select2"><option>Se&ccedil;iniz</option><option value="Muhasebe">Muhasebe</option><option value="Dış İşlemler">Dış İşlemler</option><option value="Krediler">Krediler</option><option value="Bilgi Teknolojileri">Bilgi Teknolojileri</option><option value="Destek Hizmetler">Destek Hizmetler</option><option value="Risk Y&ouml;netimi">Risk Y&ouml;netimi</option><option value="İ&ccedil; Kontrol">İ&ccedil; Kontrol</option><option value="Fon Y&ouml;netimi">Fon Y&ouml;netimi</option><option value="İnsan Kaynakları">İnsan Kaynakları</option></select><LABEL for="ikform_ogrenim"></LABEL></td></tr><tr><td bgcolor="#F3F3F3">İş Tecr&uuml;besi:</td><td bgcolor="#F3F3F3"><LABEL for="ikform_tecrube"></LABEL><textarea name="ikform_tecrube" id="ikform_tecrube" cols="30" rows="4"></textarea></td></tr><tr><td bgcolor="#F3F3F3">Yabancı Dil:</td><td bgcolor="#F3F3F3"><LABEL for="ikform_dil"></LABEL><textarea name="ikform_dil" id="ikform_dil" cols="30" rows="4"></textarea></td></tr><tr><td bgcolor="#F3F3F3">Notlar:</td><td bgcolor="#F3F3F3"><LABEL for="ikform_notlar"></LABEL><textarea name="ikform_notlar" id="ikform_notlar" cols="30" rows="4"></textarea></td></tr><tr><td bgcolor="#F3F3F3">&nbsp;</td><td bgcolor="#F3F3F3"><input type="submit" name="bt_gonder" id="bt_gonder" value="G&ouml;nder"> <input type="reset" name="bt_temizle" id="bt_temizle" value="Temizle"></td></tr>
  </table></td>
</tr>
</table></td>
        </tr>
