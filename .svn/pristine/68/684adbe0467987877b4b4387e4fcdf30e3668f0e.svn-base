              ...
              <table width="900" border="0" align="center" cellpadding="0" cellspacing="2" class="template">
               ...
               <?php do { ?>
                 <tr align="center" valign="middle" bgcolor="#CCCCCC">
                   <td><?php echo $row_rc_tumkullanicilar['uye_user_adi_m']; ?></td>
                   <td><?php echo $row_rc_tumkullanicilar['uye_giris_saati']; ?></td>
                   <td><?php echo $row_rc_tumkullanicilar['uye_cikis_saati']; ?></td>
                   <td><?php echo $row_rc_tumkullanicilar['ip_adresi']; ?></td>
                   </tr>
