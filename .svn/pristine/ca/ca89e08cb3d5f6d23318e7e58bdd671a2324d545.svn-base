...
if (isset($_GET['reportPeriod']))
    $raporDonemi = GetSQLValueString(strip_tags($_GET['reportPeriod']), "int");
else 
    $raporDonemi = '';
...
$query_rc_finansaltablo2012 = "SELECT * FROM finansal_raporlar_en where yil='".$raporDonemi."'";
...
//echo "aaaaaaaaa".$query_limit_rc_finansaltablo2012;
  ...
  <div id="div_footer_template">
    ...
    <table width="980" height="30" border="0" cellpadding="0">
      ...
      <tr>
        ...
        <td height="30" align="center"><span id="footer" style="font-size:9px;font-family:Arial;color:#666;text-align:center">Copyright © 2011 Bank Mellat Türkiye İstanbul Merkez �?ubesi</span></td>
