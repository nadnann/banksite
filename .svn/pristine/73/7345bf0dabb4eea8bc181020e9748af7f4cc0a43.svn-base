  ...
  <div id="div_icerik_template"><!-- InstanceBeginEditable name="duzenlenilirAlan" -->
    ...
    <table width="960" height="300" border="0" align="center" cellpadding="4" cellspacing="7" class="table_border" id="Table_" vspace="0">
      <tr>
        ...
        <td width="730" colspan="-5" align="left" valign="top"><header class="template_baslik">PRODUCT AND SERVICE FEES</header><p></p>
        <p class="parag">
 <ul>
  <!--
  <li class="ul_parag"><a href="personelcustomer.php" class="paraglink">Personel Customer</a></li>
  <li class="ul_parag"><a href="commercial_customer.php" class="paraglink">Commercial / Corporate Customer</a></li>

-->
	<li class="ul_parag"><a href="personelcustomer.php" class="paraglink">Product and Service Fees</a></li>    
</ul>  
</p> 
