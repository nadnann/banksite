...
$sayfa_adi="Financial Reports 2009";
...
<header class="template_baslik"><b>FINANCIAL REPORTS - 2009 YEARS</b></header>
  ...
  <tr>
    ...
    <table width="680" cellpadding="2" cellspacing="1" border="1" bordercolor="#CCCCCC">
      <tr class="financialr_baslik">
        <td width="114" align="center" valign="top" class="transparan">Date</td>
        <td width="390" align="left" valign="top" class="transparan">Description</td>
        <td width="160" align="center" valign="middle">Format</td>
      </tr>
      <tr>
        <td align="center" valign="middle" bgcolor="#f0f3f7" class="financialr_alt_baslik">2009</td>
        <td align="left" valign="middle" bgcolor="#f0f3f7" class="financialr_alt_baslik">1st Quarter Financial Report</td>
        <td align="center" valign="middle" bgcolor="#f0f3f7" class="financialr_alt_baslik"><a href="../document/financial_reports/2009/BankMellatTemp_310309.pdf" target="_blank"><img src="../image/pdf_icon.png" width="16" height="16" border="0"/></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" class="transparan">2009</td>
        <td align="left" valign="middle" class="transparan">1st Quarter Audit Report</td>
        <td align="center" valign="middle"><a href="../document/financial_reports/2009/Bank Mellat200903TRFI.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" bgcolor="#f0f3f7" class="transparan">2009</td>
        <td align="left" valign="middle" bgcolor="#f0f3f7" class="transparan">2nd Quarter Financial Report </td>
        <td align="center" valign="middle" bgcolor="#f0f3f7"><a href="../document/financial_reports/2009/BankMellatTemp_300609.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr class="financialr_alt_baslik"></tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" class="transparan">2009</td>
        <td align="left" valign="middle" class="transparan">2nd Audit Report</td>
        <td align="center" valign="middle"><a href="../document/financial_reports/2009/Bank Mellat200903TRFI.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" bgcolor="#F0F3F7" class="transparan">2009</td>
        <td align="left" valign="middle" bgcolor="#F0F3F7" class="transparan">3rd Quarter Financial Report</td>
        <td align="center" valign="middle" bgcolor="#F0F3F7"><a href="../document/financial_reports/2009/BankMellatTemp_200909.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" class="transparan">2009</td>
        <td align="left" valign="middle" class="transparan">3rd Quarter Audit Report</td>
        <td align="center" valign="middle"><a href="../document/financial_reports/2009/Bank Mellat200909TRFI.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" bgcolor="#F0F3F7" class="transparan">2009</td>
        <td align="left" valign="middle" bgcolor="#F0F3F7" class="transparan">4th Quarter Financial Report<br />(Published, Turkish Trade Registry Gazette on 7539 with date 08.04.2010 , Resmi Gazete on 27555 with date 17.04.2010)</td>
        <td align="center" valign="middle" bgcolor="#F0F3F7"><a href="../document/financial_reports/2009/BankMellatTemp_200912.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" class="transparan">2009</td>
        <td align="left" valign="middle" class="transparan">Bank Mellat 2009 Annual Report</td>
        <td align="center" valign="middle"><a href="../document/financial_reports/2009/BankMellatAnnual2009eng.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
    </table></td>
  </tr>
</table></td>        
