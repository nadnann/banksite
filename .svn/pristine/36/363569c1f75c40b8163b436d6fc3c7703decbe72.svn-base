        ...
        <td align="center" valign="middle"><table width="970" height="126" border="0" align="center" cellpadding="4" cellspacing="7" class="table_border" id="Table_" vspace="0">
          <tr>
            ...
            <p class="parag"> Kullanıcı Adı: <b><?php echo ucwords($_SESSION['MM_Username1']); ?></b> </p>
             <p class="parag"> Giriş Saati: <b><?php echo $_SESSION['MM_girissaati']; ?></b></p>
             ...
             <p class="parag"><b><img src="images/ok.png" width="16" height="16" /> Duyurularunuz eklenmiştir.</b></p>
             
             <p class="parag"><b><a href="e77ba53855duyurular.php" class="paraglink"> Tüm Duyurular</a></b></p>
             </td>
          </tr>
        </table>
          <br /></td>
