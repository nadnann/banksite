...
$sayfa_adi="Financial Reports 2007";
...
<header class="template_baslik"><b>FINANCIAL REPORTS - 2007 YEARS</b></header>
<table width="670" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#F2F2F2" class="table_border">
  <tr>
    ...
    <table width="680" cellpadding="2" cellspacing="1" border="1" bordercolor="#CCCCCC">
      ...
      <tr>
        <td align="center" valign="middle" bgcolor="#f0f3f7" class="financialr_alt_baslik">2007</td>
        <td align="left" valign="middle" bgcolor="#f0f3f7" class="financialr_alt_baslik">1st Quarter</td>
        <td align="center" valign="middle" bgcolor="#f0f3f7" class="financialr_alt_baslik"><a href="../document/financial_reports/2007/BankMellat200701a.pdf" target="_blank"><img src="../image/pdf_icon.png" width="16" height="16" border="0"/></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" class="transparan">2007</td>
        <td align="left" valign="middle" class="transparan">2nd Quarter</td>
        <td align="center" valign="middle"><a href="../document/financial_reports/2007/BankMellat200702.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" bgcolor="#f0f3f7" class="transparan">2007</td>
        <td align="left" valign="middle" bgcolor="#f0f3f7" class="transparan">3rd Quarter</td>
        <td align="center" valign="middle" bgcolor="#f0f3f7"><a href="../document/financial_reports/2011/BankMellat200703.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" class="transparan">2007</td>
        <td align="left" valign="middle" class="transparan">4th Quarter </td>
        <td align="center" valign="middle"><a href="../document/financial_reports/2007/BankMellat200704.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" bgcolor="#F0F3F7" class="transparan">2007</td>
        <td align="left" valign="middle" bgcolor="#F0F3F7" class="transparan">Annual Report</td>
        <td align="center" valign="middle" bgcolor="#F0F3F7"><a href="../document/financial_reports/2007/BankMellatAnnual2007eng.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
    </table></td>
  </tr>
</table></td>        
