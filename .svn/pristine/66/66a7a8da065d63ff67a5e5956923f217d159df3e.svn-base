...
?>
    ...
    <table width="960" height="300" border="0" align="center" cellpadding="4" cellspacing="7" class="table_border" id="Table_" vspace="0">
      <tr>
        <td width="230" height="90" align="left" valign="top"><img src="../image/image_ir/intercommunication.jpg" width="230" height="325" class="resim" /></td>
        <td width="730" colspan="-5" align="left" valign="top"><header class="template_baslik">Usefull website to be glanced in your Iranian connections</header>

         <p class="parag">
 <ul>
<li class="ul_parag"><a href="http://en.bankmellat.ir/portal.aspx" target="_blank" class="paraglink">Bank Mellat IRAN</a></li>
<li class="ul_parag"><a href="http://www.bddk.org.tr/WebSitesi/English.aspx" target="_blank" class="paraglink">Banking Regulation and Supervision Agency</a></li>
<li class="ul_parag"><a href="http://www.tbb.org.tr/eng/default.aspx" target="_blank" class="paraglink">The Banks Association Of Turkey</a></li>
