...
<table width="965" border="1" bordercolor="#000" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td colspan="3"><table width="965" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
      ...
      <tr>
        <td width="230" height="90" align="left" valign="top"><img src="../image/image_ir/Internalbranches.jpg" width="230" height="325" class="resim" /></td>
        <td width="730" colspan="-5" align="left" valign="top"><header class="template_baslik">HUMAN RESOURCE-SEND YOUR CV</header>
          <table width="675" align="center">
          <tr>            </tr>
          </table>
          <table width="675" align="center" class="table_border">
            <tr>
              <td><table width="675" align="center">
                ...
                <form action="" method="post" enctype="multipart/form-data" name="send_cv" id="send_cv">
                  <table width="100%" align="center" cellspacing="1">
                    <tr>
                      <td width="122" align="left" valign="middle" class="div_iban_baslik1">Your Name Surname:</td>
                      <td width="544"><span id="sprytextfield1" >
                    ...
                    <tr>
                      <td align="left" valign="middle" class="div_iban_baslik1">E-Mail Address:</td>
                    ...
                    <tr>
                      <td align="left" valign="middle" class="div_iban_baslik1">Position:</td>
                    ...
                    <tr>
                      <td align="right" valign="middle" class="div_iban_baslik1">&nbsp;</td>
                      <td style="font-family:Arial;font-size:11px;color:#333333"><label for="attachment"></label>
                        <input type="file" name="attachment" id="attachment" />
                        <span class="div_iban_baslik1">(.doc,.docx,.pdf,.rar,.zip)</span></td>
                    </tr>
                    <tr>
                      <td class="div_iban_baslik1">&nbsp;</td>
                      <td><input type="submit" name="button" id="button" value="Send CV" />
                        <span class="sendmail">
                          <? 
