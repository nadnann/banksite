             ...
             <table width="934" border="0" align="center" cellpadding="2" cellspacing="2" class="template">
               ...
               <?php do { ?>
                 <tr align="center" valign="middle" bgcolor="#E6E6E6">
                   <td><?php echo $row_Recordset1['duyuru_id']; ?></td>
                   <td><?php echo $row_Recordset1['duyuru_adi']; ?></td>
                   <td align="left"><?php echo $row_Recordset1['duyuru_metni']; ?></td>
                   ...
                   <td> &nbsp;<a href="d56b699830e77baduyurular_ekle.php"><img src="images/ekle.png" width="16" height="16" border="0" /></a> <a href="d56b699830e77ba53855duyurular_edit.php?id=<?php echo $row_Recordset1['duyuru_id']; ?>"><img src="images/duzenle.png" width="16" height="16" border="0" /></a>&nbsp; <a href="d56b699830e77ba53855duyurular_delete2.php?id=<?php echo $row_Recordset1['duyuru_id']; ?>"><img src="images/delete.png" width="16" height="16" border="0" /></a></td>
                 </tr>
