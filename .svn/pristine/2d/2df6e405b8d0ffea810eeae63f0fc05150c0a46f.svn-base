...
$query_rc_tumkullanicilar = "SELECT * FROM uye_islemleri ORDER BY uye_giris_saati DESC";
        ...
        <td align="center" valign="middle"><table width="970" height="126" border="0" align="center" cellpadding="4" cellspacing="7" class="table_border" id="Table_" vspace="0">
          <tr>
           ...
           <p class="parag">&nbsp;<a href="d56b699830e77ba53855679cb1d252da01.php" class="paraglink"><img src="images/Home.png" width="24" height="24" border="0" />Anasayfa</a></p>
             <p class="parag"><b>Sistemde Kayýtlý Kullanýcýlarýn Sisteme Giriþ Saatleri / Çýkýþ Saatleri</b></p>
              <table width="900" border="0" align="center" cellpadding="0" cellspacing="2" class="template">
               <tr>
                 <th align="center" valign="middle">Üye Adý</th>
                 <th align="center" valign="middle">Üye Giriþ Saati</th>
                 <th align="center" valign="middle">Üye &Ccedil;ýkýþ Saati</th>
                 <th align="center" valign="middle">Ýp Adresi</th>
                 </tr>
               <?php do { ?>
                 <tr align="center" valign="middle" bgcolor="#CCCCCC">
                   <td><?php echo strip_tags($row_rc_tumkullanicilar['uye_user_adi_m']); ?></td>
                   <td><?php echo strip_tags($row_rc_tumkullanicilar['uye_giris_saati']); ?></td>
                   <td><?php echo strip_tags($row_rc_tumkullanicilar['uye_cikis_saati']); ?></td>
                   <td><?php echo strip_tags($row_rc_tumkullanicilar['ip_adresi']); ?></td>
                   </tr>
