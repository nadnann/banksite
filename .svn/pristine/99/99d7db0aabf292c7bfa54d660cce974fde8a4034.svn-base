...
$sayfa_adi="Financial Reports 2008";
...
<header class="template_baslik"><b>FINANCIAL REPORTS - 2008 YEARS</b></header>
<table width="670" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#F2F2F2" class="table_border">
  <tr>
    ...
    <table width="680" cellpadding="2" cellspacing="1" border="1" bordercolor="#CCCCCC">
      ...
      <tr>
        <td align="center" valign="middle" bgcolor="#f0f3f7" class="financialr_alt_baslik">2008</td>
        <td align="left" valign="middle" bgcolor="#f0f3f7" class="financialr_alt_baslik"> Annual Report</td>
        <td align="center" valign="middle" bgcolor="#f0f3f7" class="financialr_alt_baslik"><a href="../document/financial_reports/2008/BankMellatAnnual2008eng.pdf" target="_blank"><img src="../image/pdf_icon.png" width="16" height="16" border="0"/></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" class="transparan">2008</td>
        <td align="left" valign="middle" class="transparan">1st Quarter </td>
        <td align="center" valign="middle"><a href="../document/financial_reports/2008/BankMellat200801.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" bgcolor="#f0f3f7" class="transparan">2008</td>
        <td align="left" valign="middle" bgcolor="#f0f3f7" class="transparan">2nd Quarter </td>
        <td align="center" valign="middle" bgcolor="#f0f3f7"><a href="../document/financial_reports/2008/BankMellat200802.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" class="transparan">2008</td>
        <td align="left" valign="middle" class="transparan">3rd Quarter</td>
        <td align="center" valign="middle"><a href="../document/financial_reports/2008/BankMellat200803.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr class="financialr_alt_baslik">
        <td align="center" valign="middle" bgcolor="#F0F3F7" class="transparan">2008</td>
        <td align="left" valign="middle" bgcolor="#F0F3F7" class="transparan">4th Quarter <br />
(Published, Turkish Trade Registry Gazette on 7298 with date 24.04.2009 , Resmi Gazete on 27214 with date 29.04.2009 )</td>
        <td align="center" valign="middle" bgcolor="#F0F3F7"><a href="../document/financial_reports/2008/BankMellat200804.pdf" target="_blank"><img src="../image/pdf_icon.png" alt="" width="16" height="16" border="0" /></a></td>
      </tr>
    </table></td>
  </tr>
</table></td>        
