...
do {  
?>
                       <option value="<?php echo $row_rc_ekleyen_kullanici['uye_user_adi']?>"<?php if (!(strcmp($row_rc_ekleyen_kullanici['uye_user_adi'], $row_rc_ekleyen_kullanici['uye_user_adi']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rc_ekleyen_kullanici['uye_user_adi']?></option>
                       <?php
