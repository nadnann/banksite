...
include_once '../includes/include_header_en.php'; 
...
?>
  ...
  <div id="div_icerik">  
     ...
     <table width="960" height="250" border="0" align="center" cellpadding="4" cellspacing="7" class="table_border" id="Table_" vspace="0">
      <tr>
        <td width="140" height="90"><a href="../image/TMSF_Deposit_Amnesty.jpg" target="_blank" class="transparan"><img src="../image/box_banner/tmsf1.gif" alt="" width="140" height="90" border="0" /></a></td>
        <td width="140" colspan="-5"><a href="product_fees.php" class="transparan"><img src="../image/box_banner/product1.gif" alt="" width="140" height="90" border="0" /></a></td>
  ...
  <tr>
    <td align="center" height="13" valign="top" class="table_headerB">Turkish Central Bank Exchange Rates</td>
  </tr>
  <tr>
    <td height="82"><table width="300" border="0" align="center" cellpadding="2" cellspacing="1">
      ...
      <tr class="table_icerikbir">
        ...
        <td width="37%" align="center"><?php echo $TCMB->AlisGetir( "USD" )?>  TL </td>
        <td width="35%" align="center"><?php echo $TCMB->SatisGetir( "USD" )?> TL</td>
      </tr>
    <?php
	...
	?>
      ...
      <?php $TCMB->KurBelirle( "IRR" ); ?>
      
      <tr align="center" class="table_icerikuc">
        <td height="20"> IRR </td>
        <td><?=$TCMB->AlisGetir()?> TL</td>
        <td><?=$TCMB->SatisGetir()?> TL</td>
      </tr>
    </table></td>
  </tr>
</table>
  ...
  <table width="292" height="auto" border="0" align="left" cellpadding="0">
    <tr>
      ...
      <!--
        ...
        <td><a href="branch_contact.php" class="transparan"><img src="../image/box_banner/contact.jpg" width="140" height="90" border="0"/></a></td>
       </tr>
     </table>
  </div>
    ...
    <table width="980" height="150" border="0" cellpadding="0">
      <tr>
        ...
        <table width="884" height="120" border="0" align="center" cellpadding="0" cellspacing="5">
          <tr>
            <td width="123" height="34" align="left" valign="top" class="altmenu">
            	<a href="history.php" class="altmenu1">History</a><br />
              <a href="mission.php" class="altmenu1">Mission and Vision</a><br />
              <a href="information.php" class="altmenu1">Information</a><br />
            ...
            <td width="134" align="left" valign="top" class="altmenu">
            ...
            <td width="120" align="left" valign="top" class="altmenu">
            <a href="branch_istanbul.php" class="altmenu1">Branches</a><br />
              <a href="branch_istanbul.php" class="altmenu1">Istanbul Main Branch</a><br />
              <a href="branch_ankara.php" class="altmenu1">Ankara Branch</a><br />
              <a href="branch_izmir.php" class="altmenu1">Izmir Branch</a></td>
            <td width="175" align="left" valign="top" class="altmenu"> Recently Viewed <br />
              <?php do { ?>
                <?php echo $row_rc_songezdik['sayfa_adi']; ?><br />
                <?php } while ($row_rc_songezdik = mysqli_fetch_assoc($rc_songezdik)); ?></td>
            <td width="302" align="left" valign="top" class="altmenu"><b> Account Openning Form </b>
            ...
            <br /><a href="../en/bireysel_musteri/personaldataprotection.pdf" class="altmenu1" target="_blank">Information Note On Personal Data Protection</a>
             </td>
          </tr>
        </table></td>
      </tr>
