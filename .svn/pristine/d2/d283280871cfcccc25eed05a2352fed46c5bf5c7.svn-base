...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM finansal_raporlar_en WHERE id=%s",
  ...
  $deleteGoTo = "e77ba5385_finansal_raporlar_sil2_en.php";
                 ...
                 <td><form id="form_sil" name="form_sil" method="post" action="">
                   <table width="700" border="0" cellspacing="0" cellpadding="0">
                     ...
                     <tr>
                       ...
                       <td width="475"><label>
                         <input name="finansal_rapor_adi" type="text" id="finansal_rapor_adi" value="<?php echo $row_rc_finansal_sil['aciklama']; ?>" size="30" />
                       </label></td>
                     </tr>
                     <tr>
                       <td>Finansal Rapor Eklenme Tarihi:</td>
                       <td><label>
                         <input name="finansal_rapor_tarihi" type="text" id="finansal_rapor_tarihi" value="<?php echo $row_rc_finansal_sil['eklenme_tarihi']; ?>" size="30" />
                       </label></td>
                     </tr>
                     <tr>
                       <td>&nbsp;</td>
