...
?>
    ...
    <table width="960" height="300" border="0" align="center" cellpadding="4" cellspacing="7" class="table_border" id="Table_" vspace="0">
      <tr>
        ...
        <td width="730" colspan="-5" align="left" valign="top"><header class="template_baslik">AVALIZATIONS</header><p></p>
          <p class="parag">Wherever drawer of bill of exchange wishes any other bank's avalization or acceptance, those banks may put their guarantee on the said documents either by avalizing or accepting them by their signatures if the credibility, capacity and capability of drawee is available. Our customers bearing above conditions may recourse at us if they are in need of such guarantees against the acceptable collaterals as itemized in Loans section..</p>
