...
$query_Recordset1 = "SELECT * FROM duyurular";
...
<p class="parag">&nbsp;<a href="d56b699830e77ba53855679cb1d252da01.php" class="paraglink"><img src="images/Home.png" width="24" height="24" border="0" />Anasayfa</a></p>
             ...
             <table width="934" border="0" align="center" cellpadding="2" cellspacing="2" class="template">
               <tr bgcolor="#D6D6D6">
                 <th width="115" align="center" valign="middle">Duyuru No</th>
                 <th width="121" align="center" valign="middle">Duyuru Adý</th>
                 <th width="132" align="center" valign="middle">Duyuru Metni</th>
                 <th width="122" align="center" valign="middle">Duyuru Link</th>
                 <th width="130" align="center" valign="middle">Duyuru Tarihi</th>
                 <th width="187" align="center" valign="middle">Ekleyen Kullanýcý</th>
                 <th width="100" align="center" valign="middle">&nbsp;</th>
               </tr>
               <?php do { ?>
                 <tr align="center" valign="middle" bgcolor="#E6E6E6">
                   <td><?php echo strip_tags($row_Recordset1['duyuru_id']); ?></td>
                   <td><?php echo strip_tags($row_Recordset1['duyuru_adi']); ?></td>
                   <td align="left"><?php echo strip_tags($row_Recordset1['duyuru_metni']); ?></td>
                   <td><?php echo strip_tags($row_Recordset1['duyuru_link']); ?></td>
                   <td><?php echo strip_tags($row_Recordset1['duyuru_tarihi']); ?></td>
                   <td><?php echo strip_tags($row_Recordset1['duyuru_ekleyen_kullanici']); ?></td>
                   <td> &nbsp;<a href="d56b699830e77baduyurular_ekle.php"><img src="images/ekle.png" width="16" height="16" border="0" /></a> <a href="d56b699830e77ba53855duyurular_edit.php?id=<?php echo strip_tags($row_Recordset1['duyuru_id']); ?>"><img src="images/duzenle.png" width="16" height="16" border="0" /></a>&nbsp; <a href="d56b699830e77ba53855duyurular_delete2.php?id=<?php echo strip_tags($row_Recordset1['duyuru_id']); ?>"><img src="images/delete.png" width="16" height="16" border="0" /></a></td>
                 </tr>
