              ...
              <table width="900" border="0" cellpadding="0" cellspacing="2" class="template">
               ...
               <?php do { ?>
                 <tr align="center" valign="middle" bgcolor="#CCCCCC">
                   <td><?php echo $row_rc_tumkullanicilar['uye_id']; ?></td>
                   <td><?php echo $row_rc_tumkullanicilar['uye_adi']; ?></td>
                   <td><?php echo $row_rc_tumkullanicilar['uye_soyadi']; ?></td>
                   <td><?php echo $row_rc_tumkullanicilar['uye_user_adi']; ?></td>
                   <td><?php echo $row_rc_tumkullanicilar['uye_grup']; ?></td>
                   <td><?php echo $row_rc_tumkullanicilar['uye_kayit_tarihi']; ?></td>
                 </tr>
