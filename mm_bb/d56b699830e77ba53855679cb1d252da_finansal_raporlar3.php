...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO finansal_raporlar (yil, aciklama, link, ekleyen_kullanici, eklenme_tarihi) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['rapor_yil'], "int"),
                       GetSQLValueString($_POST['rapor_adi'], "text"),
                       GetSQLValueString($_POST['rapor_link'], "text"),
                       GetSQLValueString($_POST['tarih_kullanici'], "text"),
  ...
  $insertGoTo = "d56b699830e77ba53855679cb1d252da_finansal_raporlar4.php";
  if (isset($_SERVER['QUERY_STRING'])) {
                    ...
                    <tr>
                      <td><table width="600" border="0" cellpadding="0" cellspacing="0" class="template">
                        ...
                        <tr>
                          ...
                          <td><label>
                            <input name="tarih_kullanici" type="text" id="tarih_kullanici"  value="<? echo $_SESSION['MM_Username1']; ?>" readonly="readonly"/>
                          </label></td>
                        </tr>
                        <tr>
