...
$rc_duyurular = mysql_query($query_rc_duyurular, $connection_lcl) or die(mysql_error());
$row_rc_duyurular = mysql_fetch_assoc($rc_duyurular);
$totalRows_rc_duyurular = mysql_num_rows($rc_duyurular);
  ...
  <tr>
    <td height="82"><table width="300" border="0" align="center" cellpadding="2" cellspacing="1">
      ...
      <tr class="table_icerikbir">
        ...
        <td width="37%" align="center"><?=$TCMB->AlisGetir( "USD" )?> TL </td>
        <td width="35%" align="center"><?=$TCMB->SatisGetir( "USD" )?> TL</td>
      </tr>
      <?
      $TCMB->KurBelirle( "EUR" );
	?>
      <tr align="center" class="table_icerikiki">
        <td height="21">EUR </td>
        <td width="37%"><?=$TCMB->AlisGetir()?>          TL</td>
        <td width="35%"><?=$TCMB->SatisGetir()?>          TL</td>
      </tr>
      <? $TCMB->KurBelirle( "IRR" ); ?>
      ...
      <tr>
        ...
        <table width="885" height="120" border="0" align="center" cellpadding="0" cellspacing="5">
          <tr>
            ...
            <td width="166" align="left" valign="top" class="altmenu">Di�er Bankac�l�k Hizmetleri</b></span><br />
            ...
            <td width="145" align="left" valign="top" class="altmenu">�ubeler<br />
            ...
            <td width="227" align="left" valign="top" class="altmenu"><b> Hesap A��l�� Formu</b>
              <br /><a href="../document/GERCEK_KISI_TUR.pdf" class="altmenu1" target="_blank">Ger�ek Ki�i M��teri Sabiti Bilgileri</a>
              <br /><a href="../document/TUZEL_KISI_TURKCE.pdf" class="altmenu1" target="_blank">T�zel Ki�i M��teri Sabiti Bilgileri</a>
