...
<div id="div_main" align="center"> 
  ...
  <div id="div_top_country">BANK MELLAT TÜRKÝYE ÝSTANBUL MERKEZ ÞUBESÝ </div>
    ...
    <div id="div_top_lang"> <a href="index.php" title="Türkçe">&nbsp;&nbsp;&nbsp;TR&nbsp;&nbsp;&nbsp;</a>|<a href="../en/index.php" title="Ýngilizce">&nbsp;&nbsp;&nbsp;EN&nbsp;&nbsp;&nbsp;</a></div>
...
?>
  ...
  <!-- InstanceBeginEditable name="duzenlenilirAlan" -->
    ...
    <table width="960" height="300" border="0" align="center" cellpadding="4" cellspacing="7" class="table_border" id="Table_" vspace="0">
      <tr>
        <td width="230" height="90" align="left" valign="top"><img src="../image/image_ir/faalsazi.jpg" width="230" height="325" class="resim" /></td>
        <td width="730" colspan="-5" align="left" valign="top"><header class="template_baslik">BAÐLANTILAR</header><p></p>
         

<p class="parag">
 <ul>
<li class="ul_parag"><a href="http://en.bankmellat.ir/portal.aspx" target="_blank" class="paraglink">Bank Mellat ÝRAN</a></li>
<li class="ul_parag"><a href="http://www.bddk.org.tr" target="_blank" class="paraglink">Bankacýlýk Düzenleme ve Denetleme Kurumu (BDDK)</a></li>
<li class="ul_parag"><a href="http://www.tbb.org.tr/tr/" target="_blank" class="paraglink">Türkiye Bankalar Birliði</a></li>
  ...
  <div id="div_footer_template">
    ...
    <table width="980" height="30" border="0" cellpadding="0">
      ...
      <tr>
        ...
        <td height="30" align="center"><span id="footer" style="font-size:9px;font-family:Arial;color:#666;text-align:center">Copyright Â© 2011 Bank Mellat TÃ¼rkiye Ä°stanbul Merkez Åžubesi</span></td>
