...
<meta name="keywords" content="mellat bank,mellat bank türkiye,bank mellat,bank mellat türkiye,iran,banka,iran banka,bankacılık,uluslararası bankacılık">
...
<div id="div_main" align="center"> 
  ...
  <div id="div_top_country">BANK MELLAT TÜRKİYE İSTANBUL MERKEZ ŞUBESİ </div>
    ...
    <div id="div_top_content"><a href="../links.php">&nbsp;&nbsp;&nbsp;Bağlantılar&nbsp;&nbsp;&nbsp;</a>|<a href="http://en.bankmellat.ir/portal.aspx">&nbsp;&nbsp;&nbsp;Bank Mellat İran&nbsp;&nbsp;&nbsp;</a></div>

    

    <div id="div_top_lang"> <a href="../index.php" title="Türkçe">&nbsp;&nbsp;&nbsp;TR&nbsp;&nbsp;&nbsp;</a>|<a href="../../en/index.php" title="İngilizce">&nbsp;&nbsp;&nbsp;EN&nbsp;&nbsp;&nbsp;</a></div>
      ...
      <tr align="left" valign="top">
        ...
        <td><ul id="sddm">
          ...
          <li><a href="#" onmouseover="mopen('m1')" onmouseout="mclosetime()">Hakkımızda</a>
            ...
            <div id="m1" onmouseover="mcancelclosetime()" onmouseout="mclosetime()"> <a href="../tarihce.php">Tarihçemiz&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> 

            <a href="../organizasyon.php">Organizasyon&nbsp;&nbsp;</a> <a href="../mkurulu.php">Müdürler Kurulu&nbsp;</a> <a href="../misyon.php">Misyon & Vizyon&nbsp;&nbsp;</a> <a href="../b_teknoloji.php">Bilgi Teknolojileri&nbsp;&nbsp;</a> <a href="../insan_kaynaklari.php">İnsan Kaynakları&nbsp;</a> </div>

          </li>

          <li><a href="#" onmouseover="mopen('m2')" onmouseout="mclosetime()">Sağlanan Hizmetler</a>

            <div id="m2" onmouseover="mcancelclosetime()" onmouseout="mclosetime()"> <a href="../mevduatlar.php">Mevduatlar&nbsp;&nbsp;&nbsp;</a> <a href="../yatirimlar.php">Yatırımlar&nbsp;&nbsp;&nbsp;</a> <a href="../zaman_asimi.php">Zaman Aşımı Hesapları&nbsp;&nbsp;&nbsp;</a> <a href="../diger_bankacilik_hizmetleri.php">Diğer Bankacılık Hizmetleri&nbsp;&nbsp;&nbsp;</a> </div>

          </li>

          <li><a href="#" onmouseover="mopen('m3')" onmouseout="mclosetime()">Şartlar & Koşullar</a>

            <div id="m3" onmouseover="mcancelclosetime()" onmouseout="mclosetime()"> <a href="../bireysel_musteri.php">Bireysel Müşteri</a> <a href="../kurumsal_musteri.php">Ticari / Kurumsal Müşteri</a> </div>

          </li>

          <li><a href="#" onmouseover="mopen('m4')" onmouseout="mclosetime()">Şubeler </a>

            <div id="m4" onmouseover="mcancelclosetime()" onmouseout="mclosetime()"> <a href="../sube_istanbul.php">İstanbul Merkez Şubesi&nbsp;</a> 

            <a href="../sube_ankara.php">Ankara Şubesi&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> 

            <a href="../sube_izmir.php">İzmir Şubesi&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> </div>
...
?>
  ...
  <!-- InstanceBeginEditable name="duzenlenilirAlan" -->
      ...
      <tr>
        ...
        <td width="230" height="90" align="left" valign="top"><img src="../image/image_ir/history.jpg" width="230" height="325" class="resim" /></td>

        <td width="730" colspan="-5" align="left" valign="top"><header class="template_baslik">TARİHİMİZ</header><p></p>

          <p class="parag"> BANK MELLAT TURKEY as hundred percent subsidiary of BANK MELLAT IRAN, has first been inaugurated upon a Permission granted by council of Ministers with the decree issued on February 05 th 1981 NR.8/2406 and began to operate with Istanbul Turkey Main Branch on April 16 th 1982 which later on by the Establishment of Ankara and Izmir Branches on may 15 th 1985 and October 20 th 1992 respectively the Bank has completed its initial structure.</p>

<p class="parag">As prominent foreign body of BANK MELLAT / IRAN overseas Branches, BANK MELLAT / TURKEY has served domestic economic Activities as well as the joint efforts on Iranian and Turkish projects, specially enhancing commercial trade between the two countries.</p></td>
