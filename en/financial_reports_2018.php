...
$sayfa_adi="Financial Reports 2018";
...
mysql_select_db($database_connection_lcl, $connection_lcl);
$query_rc_finansalrapor_en = "SELECT * FROM finansal_raporlar_en where yil='2018'";
...
<header class="template_baslik"><b>FINANCIAL REPORTS - 2018 YEARS</b></header>
