...
<div id="div_main" align="center">
  ...
  <div id="div_top_country">BANK MELLAT-TURKEY</div>
    ...
    <div id="div_top_content"><a href="links.php">&nbsp;&nbsp;&nbsp;Links&nbsp;&nbsp;&nbsp;</a>|<a href="http://www.bankmellat.ir">&nbsp;&nbsp;&nbsp;Bank Mellat Iran&nbsp;&nbsp;&nbsp;</a></div>
      ...
      <tr align="left" valign="top">
        ...
        <td><ul id="sddm">
          ...
          <li><a href="#" onmouseover="mopen('m4')" onmouseout="mclosetime()">Branches </a>
            ...
            <div id="m4" onmouseover="mcancelclosetime()" onmouseout="mclosetime()"> <a href="branch_istanbul.php">İstanbul Main Branch&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </a> 

            <a href="branch_ankara.php">Ankara Branch&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> 

            <a href="branch_izmir.php">İzmir Branch&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a> </div>
  ...
  <div id="div_icerik">  
     ...
     <table width="960" height="250" border="0" align="center" cellpadding="4" cellspacing="7" class="table_border" id="Table_" vspace="0">
      ...
      <tr>
        ...
        <td width="140" height="90"><a href="../image/tsarruf.jpg" class="transparan"><img src="../image/box_banner/tmsf1.gif" alt="" width="140" height="90" border="0" /></a></td>
  ...
  <table width="292" height="auto" border="0" align="left" cellpadding="0">
    ...
    <tr>
      ...
      <tr>
        ...
        <td><a href="branch_istanbul.php" class="transparan"><img src="../image/box_banner/contact.gif" width="140" height="90" border="0"/></a></td>
      ...
      <tr>
        ...
        <table width="700" height="120" border="0" align="center" cellpadding="0" cellspacing="5">
          ...
          <tr>
            ...
            <td width="125" height="34" align="left" valign="top" class="altmenu">

            	<a href="history.php" class="altmenu1">History</a><br />

              <a href="mission.php" class="altmenu1">Mission and Vision</a><br />

              <a href="information.php" class="altmenu1">İnformation</a><br />
            ...
            <td width="143" align="left" valign="top" class="altmenu">
            ...
            <td width="133" align="left" valign="top" class="altmenu">

            <a href="branch_istanbul.php" class="altmenu1">Branches</a><br />

              <a href="branch_istanbul.php" class="altmenu1">İstanbul Main Branch</a><br />

              <a href="branch_ankara.php" class="altmenu1">Ankara Branch</a><br />

              <a href="branch_izmir.php" class="altmenu1">İzmir Branch</a></td>

            <td width="133" align="left" valign="top" class="altmenu"> Recently Viewed <br />
            ...
            <td width="136" align="left" valign="top" class="altmenu"><b> Frequently Visited&nbsp;Sites</b>

              <br /><a href="branch_istanbul.php" class="altmenu1">Branches</a>

              <br /><a href="interest.php" class="altmenu1">Interest Rates</a>

            <br /><a href="human_resource.php" class="altmenu1">Human Resource</a>

            <br /><a href="personelcustomer.php" class="altmenu1">Product and Service Fees</a>

            <br /><a href="banking_services.php" class="altmenu1">Other Banking Services</a>	
