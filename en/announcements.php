  ...
  <div id="div_icerik_template"><!-- InstanceBeginEditable name="duzenlenilirAlan" -->
    ...
    <table width="960" height="300" border="0" align="center" cellpadding="4" cellspacing="7" class="table_border" id="Table_" vspace="0">
      <tr>
        ...
        <td width="730" colspan="-5" align="left" valign="top"><header class="template_baslik">ANNOUNCEMENTS</header><p></p>
          <p class="parag"><b>Announcements No: <?php echo strip_tags($row_rc_duyuru_idg['duyuru_id']); ?></b></p>
          <p class="parag"><b>Announcements Name: </b><?php echo strip_tags($row_rc_duyuru_idg['duyuru_adi']); ?></p>
           <p class="parag"><b>Announcements Description: </b><?php echo ($row_rc_duyuru_idg['duyuru_metni']); ?></p>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($row_rc_duyurular);
?>
<?
