...
<b>Information of Credit Calculation </b><a href="../en/loan_calculation.php" class="paraglink" target="_blank"><span><b>please click.</b></span></a></b>
      ...
      <tr>
        ...
        <header class="template_baslik">INTEREST RATES</header><p></p><p></p>
           ...
           <table width="550" align="center" class="template" >
              ...
              <tr>
                <td colspan="6" align="center" valign="middle" bgcolor="#E5E5E5"><b>Interest Rates for Deposit Account</b></td>
                </tr>
                              <tr>
                ...
                <td width="70" align="center" valign="middle" bgcolor="#E5E5E5">12 Months and Above</td>
                </tr>
              <tr>
			...
			<!--  <p class="parag">(*) Applied for Corporate / Commecial Customers having 100.000 and more depositsas � 0,25 % p.a.</p>-->
            <p class="parag">The interest rates stated in the table are the current annual simple interest rates  and Bank Mellat reserves the right to change the interest rates on transaction basis according to the amount or maturity.</p>
            <!--  <p class="parag">(*) Monthly – 0,2 % negative interest rate is applied for the customers and banks which has monthy average of 100.000 EUR or more on their accounts</p>-->
            <table width="675" align="center" class="template" >
         
              <tr>
                <td colspan="9" align="center" valign="middle" bgcolor="#E5E5E5"><b>Maximum Interest Rates Applied To Credits </b></td>
                </tr>
                <tr>
            ...
            <p class="parag">(*) With the exception of reimbursement credits, interest rate stipulated in the reimbursement credit agreement shall be applied.</p>
          <p class="parag">Within the framework of aggrement for prevention of double taxation concluded between Iran and Turkey, in order to exempt some of your earnings gained in Turkey from taxation and since those of the entities who earn interest yields in Turkey are expected to submit a document indicating that they are full tax-payers over their global yields, you are kindly requested to provide such document from your tax office and send us immediately having translated into turkish and certified by turkish embassy authorities in your country pls note that this document will be valid until the end of the year and be aware that such document should be renewed and sent us for each successive year in same manner.</p>
