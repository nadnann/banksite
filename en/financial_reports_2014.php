...
$sayfa_adi="Financial Reports 2014";
...
mysql_select_db($database_connection_lcl, $connection_lcl);
$query_rc_finansalrapor_en = "SELECT * FROM finansal_raporlar_en where yil='2014'";
...
<header class="template_baslik"><b>FINANCIAL REPORTS - 2014 YEARS</b></header>
