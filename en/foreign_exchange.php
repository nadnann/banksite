  ...
  <div id="div_icerik_template">
      ...
      <tr>
        ...
        <td width="730" colspan="-5" align="left" valign="top">
          <header class="template_baslik">TURKISH CENTRAL BANK EXCHANGE RATES</header><p></p>
          <table width="680" align="center" class="template" >
            <tr>
          <tr>
            <td colspan="9" align="center" valign="middle" bgcolor="#E5E5E5"><b>Current Turkish Central Bank Exchange Rates</b></td>
          </tr>
          <tr>
            <td width="96" align="center" valign="middle" bgcolor="#E5E5E5">Currency Code</td>
            <td width="45" align="center" valign="middle" bgcolor="#E5E5E5">Unit</td>
            <td width="139" align="center" valign="middle" bgcolor="#E5E5E5">Currency Name</td>
            <td width="73" align="center" valign="middle" bgcolor="#E5E5E5">Forex Buying</td>
            <td width="99" align="center" valign="middle" bgcolor="#E5E5E5">Forex Selling</td>
            <td width="79" align="center" valign="middle" bgcolor="#E5E5E5">Banknote Buying</td>
            <td width="99" align="center" valign="middle" bgcolor="#E5E5E5">Banknote Selling</td>
          </tr>
         <!--Yeni d�viz kuru  ------------------------------>
...
/*return $icerik; 
           ...
           fclose($fp); 
        echo $url["host"]." : " .$icerik;
                 return $icerik; 
                 */
           } 
           
        /*   
          @$html=file_get_content("https://www.tcmb.gov.tr/kurlar/today.xml"); 
      ...
      */ 
           /* 
        @$dovizYol = '<?xml version="1.0" encoding="ISO-8859-9"?>'.file_get_content("https://www.tcmb.gov.tr/kurlar/today.xml");
        ...
        */
        ...
        ?> 
          ...
          <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[0]->CurrencyName); ?></td>
           ...
           <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[1]->CurrencyName); ?></td>
          ...
          <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[2]->CurrencyName); ?></td>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[3]->CurrencyName); ?></td>
          ...
          <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[4]->CurrencyName); ?></td>
          ...
          <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[5]->CurrencyName); ?></td>
          ...
          <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[6]->CurrencyName); ?></td>
          ...
          <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[7]->CurrencyName); ?></td>
          ...
          <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[8]->CurrencyName); ?> </td>
	    ...
	    <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[9]->CurrencyName); ?> </td>
	    ...
	    <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[10]->CurrencyName); ?> </td>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[11]->CurrencyName); ?> </td>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[12]->CurrencyName); ?> </td>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[13]->CurrencyName); ?></td>
           ...
           <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[14]->CurrencyName); ?> </td>
           ...
           <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[15]->CurrencyName); ?></td>
          ...
          <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[16]->CurrencyName); ?> </td>
           ...
           <tr>
            ...
            <td align="left" valign="middle" bgcolor="#F5F5F5"><?php echo strip_tags($xml->Currency[17]->CurrencyName); ?> </td>
